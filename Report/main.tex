...
\usepackage{fancyhdr} % Head note and footnote
    ...
    \fancyhead[R]{\footnotesize Signal Conversion} % Right of Head note
...
\subfile{Sections/ADC_in_study.tex}
\subfile{Sections/Circuit_Analysis.tex}
\subfile{Sections/Modeling.tex}
\subfile{Sections/Simulation.tex}
\subfile{Sections/Circuit_Implementation.tex}
...
\appendix
\section{Github repository of the project} \label{apendice:github}

The following repository was criated with all the scripts and files criated and used in this project:

\begin{itemize}
    \item \textbf{CS-Lab1}: \\
    Describtion: Modeling of an  SAR ADC Exploiting Split-CDAC\\
    Link: \url{https://github.com/MartimAgostinho/CS-Lab1.git} \\
