...
In this step is important to remember that the this is a differential circuit, otherwise the DAC wont work for all bits.Now, with the weights computed the DAC output is show in Figure \ref{fig:DAC_TF}.
